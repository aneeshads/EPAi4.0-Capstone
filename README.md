...
Finally, a _generator_ node is provided which consolidates inputs from all _provider_ nodes to generate the fake data. User can specify the number of recordsin as an input in the _generator_ node.
